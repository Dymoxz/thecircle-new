...
const ViewerPage = () => {
    ...
    useEffect(() => {
        ...
        socket.onerror = (err) => console.error('[WS] Viewer WebSocket error:', err);
        ...
        <div className="container">
            ...
            <div className="sidebar">
                ...
                <ul>
                    {streams.length > 0 ? (
                        streams.map((s) => (
                            <li key={s} onClick={() => handleConnectToStream(s)}>
            ...
            <div className="main">
                <video ref={remoteVideoRef} autoPlay playsInline controls style={{ width: '100%' }}></video>
            </div>
        </div>
    );
};
