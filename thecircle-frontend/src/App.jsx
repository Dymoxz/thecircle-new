...
const TheCircleLogo = () => (
    <svg width="120" height="120" viewBox="0 0 120 120" className="mx-auto mb-6 drop-shadow-[0_4px_32px_rgba(80,0,20,0.5)]">
        <defs>
    ...
    return (
        ...
        <div className="min-h-screen w-screen bg-gradient-to-br from-[#5c0000] via-[#800000] to-[#2d0a14] text-white flex items-center justify-center p-4 relative overflow-hidden font-oswald">
            ...
            <div className="relative z-10 w-full max-w-3xl text-center">
                ...
                <p className="text-neutral-300 text-lg mb-12 font-light max-w-xl mx-auto" style={{ fontFamily: 'sans-serif' }}>
                    Secrets are power. Step inside.<br />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Link to="/streamer" className="group">
                        <div className="h-full bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center
                            ...
                            <h2 className="text-3xl font-bold uppercase tracking-wider text-white">Go Live</h2>
                            <p className="text-neutral-300 font-light" style={{ fontFamily: 'sans-serif' }}>Broadcast.</p>
                        </div>
                    </Link>
                    ...
                    <Link to="/viewer" className="group">
                        <div className="h-full bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center
                            ...
                            <h2 className="text-3xl font-bold uppercase tracking-wider text-white">Watch</h2>
                            <p className="text-neutral-300 font-light" style={{ fontFamily: 'sans-serif' }}>Join the action.</p>
                        </div>
                    </Link>
                    ...
                    <Link to="/login" className="group">
                        <div className="h-full bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center
                            ...
                            <h2 className="text-3xl font-bold uppercase tracking-wider text-white">Login</h2>
                            <p className="text-neutral-300 font-light" style={{ fontFamily: 'sans-serif' }}>Access.</p>
                        </div>
                    </Link>
                </div>
